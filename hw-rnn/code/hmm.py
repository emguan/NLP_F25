...
class HiddenMarkovModel:
    ...
    @typechecked
    def forward_pass(self, isent: IntegerizedSentence):
    ...
    @typechecked
    def backward_pass(self, isent: IntegerizedSentence, mult: float = 1):
    ...
    @typechecked
    def logprob(self, sentence: Sentence, corpus: TaggedCorpus):
