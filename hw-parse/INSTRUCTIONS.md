...
First try out the recognizer that we provided.
	...
	python ./recognize.py papa.gr papa.sen
	python ./recognize.py -v papa.gr papa.sen    # verbose output
...
it as
	...
	python ./parse.py papa.gr papa.sen | perl ./prettyprint
	python ./parse.py arith.gr arith.sen | perl ./prettyprint
	python ./parse.py english.gr english.sen | perl ./prettyprint
	python ./parse.py permissive.gr permissive.sen | perl ./prettyprint
	python ./parse.py permissive2.gr permissive.sen | perl ./prettyprint
...
So copy `parse.py` to `parse2.py` and make that version faster.
	...
	time python ./parse2.py papa.gr papa.sen | perl ./prettyprint
	time python ./parse.py papa.gr papa.sen | perl ./prettyprint

	time python ./parse2.py arith.gr arith.sen | perl ./prettyprint
	time python ./parse.py arith.gr arith.sen | perl ./prettyprint
	
	time python ./parse2.py english.gr english.sen | perl ./prettyprint
	time python ./ptest.py english.gr english.sen
	time python ./parse.py english.gr english.sen | perl ./prettyprint

	time python ./parse2.py permissive.gr permissive.sen | perl ./prettyprint
	time python ./parse2.py permissive2.gr permissive.sen | perl ./prettyprint
	time python ./parseOG.py wallstreet.gr wallstreet.sen | perl ./prettyprint
